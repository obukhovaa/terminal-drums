...
- Console widget handles 3 distinct concerns: vim mode indicator (NORMAL/COMMAND), command input with autocomplete, and status messages. These share the same 1-2 row area.
